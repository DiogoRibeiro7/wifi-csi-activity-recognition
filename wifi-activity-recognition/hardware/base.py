...
class CSIReaderBase(ABC):
    ...
    def read_batch(self, num_packets: int, timeout: Optional[float] = None) -> List[CSIData]:
        """
...
def normalize_csi_amplitude(amplitude: np.ndarray, method: str = "minmax") -> np.ndarray:
    """
